  ...
  const preview = useMemo(() => {
    ...
    const utm_content = location
      ...
      : label
        ? slugifyUtm(label)
        : "…";
    const base = destination.trim() || "https://www.prayaasessments.com";
            ...
            <form action={formAction} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="https://www.prayaasessments.com"
                  className="h-10"
                />
                <p className="text-xs text-muted-foreground">
                  Full https URL preferred. Paths like{" "}
                  <code className="text-[11px]">/offers/summer</code> also work.
                </p>
              </div>
